...
class TensorBoardImage(tf.keras.callbacks.Callback):
    ...
    def on_batch_end(self, batch, logs):
        ...
        # print("...OnBatchEnd: {}; got log keys: {} and imgs: {}".format(batch, logs,imgs.shape))
        #calculate epoch
        ...
        # print("...OnBatchEnd: {}; got log keys: {} and imgs: {}".format(batch, logs,imgs))

        with self.file_writer.as_default():
            # print("...writing files ....",imgs.shape)
